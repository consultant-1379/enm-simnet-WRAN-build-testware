...
echo "remove existing directory and creating new one"
mkdir /netsim/netsimdir/scanner
else
mkdir /netsim/netsimdir/scanner
fi
cp $Sim".zip" /netsim/netsimdir/scanner
cd  /netsim/enm-simnet-WRAN-build-testware/ERICTAFenmsimnetwranbuild_CXP9036540/src/main/resources/scripts/wran_MSRBS/bin
