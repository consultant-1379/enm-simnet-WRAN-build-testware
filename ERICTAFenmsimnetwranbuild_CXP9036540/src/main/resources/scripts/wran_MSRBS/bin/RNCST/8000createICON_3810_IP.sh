...
FILE=../icon_ip_config_file_13B.csv
...
#NUMOFDG2=`getNUMOFDG2 $RNCCOUNT $RNCRBSARRAY $RBSCELLARRAY`
NUMOFDG2=`getNumOfDG2 $RNCCOUNT $RNCDG2ARRAY`
NUMOFSCTP=`getGroup $NUMOFDG2 $MAXRBSPERSCTP`


echo "Thevalue of NUMOFDG2 is" $NUMOFDG2
...
echo "the value of NUMOFDG2 is" $NUMOFDG2 


REM=`expr $NUMOFDG2 / 126 + 1`
SLOTID=1
...
echo "the value of stop and count are $STOP $COUNT \n\n"
