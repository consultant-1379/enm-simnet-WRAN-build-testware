...
###################################################################################
#
##     File Name : new_updateip.py
##     Version : 1.00
##     Author : Siva Koteswara Rao Mogilicharla
##     Date Created : 1st Feb , 2022
#      Description : This script will update the IPs count required for a simulation in the sim folder
#      Required files : conf.txt , decisionModule.pl,  fetchOpenSim.pl, readSimData.pl
#      Patameters :
#          -release : release version
#          -deploymentType : Type of deployment
#          -simLTE/ -simCORE/ -simWRAN : LTE/CORE/WRAN simulations to be rolled out separated by ':' respectively.NO_NW_AVAILABLE if no sim present
#          -docker : yes/no - Whether the rollout is for Docker or VM
#          -switchToRv : yes/no - Whether the rollout performed is for RV or MT
#          -IPV6Per   : yes/no - whether we need combination of both IPv4 and TPv6
#
#     EXAMPLE : python new_updateip.py -deploymentType mediumDeployment -release 22.03 -simLTE NO_NW_AVAILABLE -simWRAN RNCV26449x1-FT-RBSU41410x4-RNC27 -simCORE NO_NW_AVAILABLE -switchToRv yes -IPV6Per yes -docker no
#
#######################################################################################
#
