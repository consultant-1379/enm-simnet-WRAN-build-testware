...
elsif ( $neTypeName =~ m/ECM/i ||  $neTypeName =~ m/ECEE/i || $neTypeName =~ m/OpenMano/i || $neTypeName =~ m/RNFVO/i || $neTypeName =~ m/HDS/i || $neTypeName =~ m/HP-NFVO/i) {
    ...
    || $neTypeName =~ m/IS IS/i )
{
    ...
    if ( $neTypeName =~ m/FrontHaul.*6020/i ) {
