...
echo '   subnetMask  String 255.255.255.0'  >> $MOSCRIPT$MOFILEEXTENSION
...
echo '        ipAddress String 192.168.0.1'>> $MOSCRIPT$MOFILEEXTENSION
echo '        networkMask String 255.255.255.0'>> $MOSCRIPT$MOFILEEXTENSION
