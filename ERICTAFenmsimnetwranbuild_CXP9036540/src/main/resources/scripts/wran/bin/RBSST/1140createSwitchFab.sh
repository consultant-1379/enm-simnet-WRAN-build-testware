...
CREATE: SwitchFabric, SwitchModule, InternalLinkGroup, SwitchInternalLink

SET: SwitchInternalLink, InternalLinkGroup, SwitchModule
...
MOSCRIPT=$SIMDIR/mo/$RBSDIR/switchfab.mo
