...
then
cat<<HELP
echo "liang test: total parameter: $#"
####################
# HELP
####################
...
MOSCT
    ...
    "pmDot1qTpVlanPortInFrames" Integer 0
    "pmDot1qTpVlanPortOutFrames" Integer 0
    "pmIfStatsHCIpInMcastOctets" Long 0
    "pmIfStatsHCIpInMcastPkts" Long 0
    "pmIfStatsHCIpOutMcastOctets" Long 0
    "pmIfStatsHCIpOutMcastPkts" Long 0
    "pmIfStatsIpAddrErrors" Integer 0
    "pmIfStatsIpInDiscards" Integer 0
    "pmIfStatsIpInHdrErrors" Integer 0
    "pmIfStatsIpInReceives" Integer 0
    "pmIfStatsIpOutDiscards" Integer 0
    "pmIfStatsIpOutRequests" Integer 0
    "pmIfStatsIpUnknownProtos" Integer 0
    "pmInDiscPolicy" Integer 0
    "pmInEsp" Integer 0
    "pmInPassedPolicy" Integer 0
    "pmIpIfStatsHCInOctets" Long 0
    "pmIpIfStatsHCInReceives" Long 0
    "pmIpIfStatsHCOutOctets" Long 0
    "pmIpIfStatsHCOutTransmits" Long 0
    "pmNoOfFailedPingsDefaultRouter0" Integer 0
    "pmNoOfFailedPingsDefaultRouter1" Integer 0
    "pmNoOfFailedPingsDefaultRouter2" Integer 0
    "reservedBy" Array Ref 0
    "rps" Boolean false
    "subnet" String ""
    "switchBackTimer" Integer 180
    "trafficSchedulerRef" Ref "null"
