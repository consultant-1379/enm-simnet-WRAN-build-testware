...
#fi
  ...
  echo '   moType Cabinet' >> $MOSCRIPT$MOFILEEXTENSION
  echo '   exception none' >> $MOSCRIPT$MOFILEEXTENSION
  echo '   nrOfAttributes 4' >> $MOSCRIPT$MOFILEEXTENSION
  echo "     CabinetId String "$CABID >>  $MOSCRIPT$MOFILEEXTENSION
  echo "     cabinetIdentifier String "$CABID >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     climateSystem Integer 0' >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     productData Struct' >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     nrOfElements 5' >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     productionDate String "20111221"' >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     productName String "RBS6201"' >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     productNumber String "BFM901290/064"' >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     productRevision String "R1A"' >>  $MOSCRIPT$MOFILEEXTENSION
  echo '     serialNumber String "CC48118333"' >>  $MOSCRIPT$MOFILEEXTENSION
  echo ')' >> $MOSCRIPT$MOFILEEXTENSION 
