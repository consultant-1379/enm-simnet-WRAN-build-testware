...
CREATE
(
    parent "ManagedElement=$NODENAME"
    // moid = 4783
    identity "1"
...
SET
(
    mo "ManagedElement=$NODENAME,ENodeBFunction=1,TermPointToSGW=1"
    // moid = 4784
    exception none
    nrOfAttributes 1
...
SET
(
    mo "ManagedElement=$NODENAME,ENodeBFunction=1,TermPointToSGW=1,GtpPath=1"
    // moid = 4785
    exception none
    nrOfAttributes 4
...
SET
(
    mo "ManagedElement=$NODENAME,ENodeBFunction=1,SecurityHandling=1"
    // moid = 4786
    exception none
    nrOfAttributes 5
...
SET
(
    mo "ManagedElement=$NODENAME,ENodeBFunction=1,Rrc=1"
    // moid = 4787
    exception none
    nrOfAttributes 9
    "rrcId" String "1"
...
SET
(
    mo "ManagedElement=$NODENAME,ENodeBFunction=1,RlfProfile=1"
    // moid = 4788
    exception none
    nrOfAttributes 7
    "n310" Int32 20
...
SET
(
    mo "ManagedElement=$NODENAME,ENodeBFunction=1,RlfProfile=2"
    // moid = 4789
    exception none
    nrOfAttributes 7
    "n310" Int32 20
