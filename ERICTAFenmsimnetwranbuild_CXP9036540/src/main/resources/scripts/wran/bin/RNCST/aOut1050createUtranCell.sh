...
##################################################
# Ver7        : ENM 24.04
# Purpose     : PrimaryScramblingCode attribute value shouldbe lessthan128 to maintain consistency with LTE,GSM
# Description : PrimaryScramblingCode attribute should be lessthan 128, as the ExternalUtranCellTDD physicalcellidentity attribute has range from 0 to 128, to maintai consistency required this change
# Date        : 08 01 2024
# Who         : Saivikas Jaini
##################################################
