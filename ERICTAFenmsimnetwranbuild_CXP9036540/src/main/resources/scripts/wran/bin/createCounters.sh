...
cd RNCST/
./3000createRNC_Direct_Connection_MUB_Crossconnected.sh $SIMNAME $ENV $NUMOFRNC

if [ "$RBS_NODE_CREATION" == "YES" ]
then
cd ../RBSST
./3000createRBS_Direct_Connection_MUB_Crossconnected.sh $SIMNAME $ENV $NUMOFRNC 1 $RBSNUM
fi
