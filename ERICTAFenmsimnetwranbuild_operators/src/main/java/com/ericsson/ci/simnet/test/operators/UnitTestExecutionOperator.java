...
@Singleton
public class UnitTestExecutionOperator implements UTestExecutionOperator {
    ...
    private static final String REMOTE_FOLDER_TAF_SCRIPTS_LOCATION = "/var/simnet/enm-simnet-WRAN-build-testware/ERICTAFenmsimnetwranbuild_CXP9036540/src/main/resources/";
    ...
    private static final String JENKINS_ENM_NI_SIMNET_JAR_FILE_SEARCH_TERM = "lib.*CXP9036540";

    /** Local zip file name for zipped embedded scripts */
    private static final String ZIP_FILE_NAME = "enm-simnet-WRAN-build-testware.zip";

    /** Logging utility */
    private static final Logger logger = LoggerFactory.getLogger(UnitTestExecutionOperator.class);

    /** Taf command handler instance */
    private CLICommandHelper cliCmdHelper;

    /**
     * Constructs a UnitTestExecutionOperator instance
     */
    public UnitTestExecutionOperator() {
    ...
    public static boolean initialise() {
        ...
        try {
            ...
            CLICommandHelper.DEFAULT_COMMAND_TIMEOUT_VALUE = 3600L * 8;
    ...
    private static boolean setUpRemoteServerFolder(final CLICommandHelper cliComandHelper) {
        ...
        cliComandHelper.execute("mkdir -v -p /var/simnet/enm-simnet-WRAN-build-testware/ERICTAFenmsimnetwranbuild_CXP9036540/src/main/resources; chown -v netsim:netsim /var/simnet/enm-simnet-WRAN-build-testware/ERICTAFenmsimnetwranbuild_CXP9036540/src/main/resources");
    ...
    private static boolean copyScriptsFolderToRemoteServer(final CLICommandHelper cliComandHelper) {
        ...
        try {
            ...
            if (Pattern.compile("testware").matcher(currentPath).find()) {
                ...
                // Search all jar files and return a file name contains lib and CXP9035174 words.
                ...
                final String destUnzipFolderName = "enm-simnet-WRAN-build-testware";
    ...
    @Override
    public int verifyUnitTestExecution(final String command) {
        ...
        //String ENV = convertToPerlCmdArg(DataHandler.getAttribute("ENV").toString());
        //String NB_Size= convertToPerlCmdArg(DataHandler.getAttribute("NB_SIZE").toString());
        String simnetParam = "";
        try {
        ...
        if (command.contains("scripts") && command.contains("startRunUnitTests.sh"))      
		...
		else if  (command.contains("scripts") && command.contains("CheckProductData.sh"))      
		...
		else if  (command.contains("scripts") && command.contains("pmFileLocation.sh"))      
