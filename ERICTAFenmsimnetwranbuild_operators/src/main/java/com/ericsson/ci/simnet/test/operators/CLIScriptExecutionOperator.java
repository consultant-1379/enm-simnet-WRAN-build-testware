...
public class CLIScriptExecutionOperator implements ScriptExecutionOperator {
    ...
    private static final String REMOTE_FOLDER_TAF_SCRIPTS_LOCATION = "/netsim/enm-simnet-WRAN-build-testware/ERICTAFenmsimnetwranbuild_CXP9036540/src/main/resources/";
    ...
    private static boolean setUpRemoteServerFolder(final CLICommandHelper cliComandHelper) {
        ...
        cliComandHelper.execute("mkdir -v -p /netsim/enm-simnet-WRAN-build-testware/ERICTAFenmsimnetwranbuild_CXP9036540/src/main/resources; chown -v netsim:netsim /netsim/enm-simnet-WRAN-build-testware/ERICTAFenmsimnetwranbuild_CXP9036540/src/main/resources");
    ...
    private static boolean copyScriptsFolderToRemoteServer(final CLICommandHelper cliComandHelper) {
        ...
        try {
            ...
            logger.error("Unable to zip/unzip the file: ", e);
            return false;
        }
    ...
    public int verifyScriptExecution(final String command) {
        ...
        String nwType = convertToPerlCmdArg(DataHandler.getAttribute("nwType").toString());
        String mixedModeReq = convertToPerlCmdArg(DataHandler.getAttribute("mixedModeReq").toString());
        ...
        try {
            ...
            if (command.contains("netsim") && command.contains("triggerBuild.sh")) {
			    String tmpCommand = command;
            	...
            	simnetParam = " " + simName + " " + nwType + " " + mixedModeReq;
